...
Admin frontend SHALL provide organizer-facing management pages for integrations and operations, while operational scanning at the gate SHALL be handled by Scanner App.
...
- **AND** admin frontend MAY provide staff assignment and scan history views
...
- **THEN** admin frontend SHALL guide the user to use Scanner App for gate scanning
